...
/**
 * The type of (redux) action which sets the dimensions of the bubbles in bubble view grid.
 *
 * {
 ...
 * }
 */
export const SET_BUBBLE_VIEW_DIMENSIONS = 'SET_BUBBLE_VIEW_DIMENSIONS';
